  ...
  return (
    <>
      <SEO
        ...
        description="Use interactive learning paths, pain-point helpers, and tactical tools to level up every Dandy's World run."
        keywords="dandys world guides, mastery help, twisted counter, trinket builder"
        ogTitle="Dandy's World Guide Hub"
        ogDescription="Choose your struggle, get instant tactics, and follow an adaptive learning path to keep the squad alive."
        ...
        twitterDescription="Interactive tactics and tools tailored to your current run."

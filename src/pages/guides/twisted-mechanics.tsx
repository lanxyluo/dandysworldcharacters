        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              Master the mechanics of Twisted characters and develop effective survival strategies
            </p>
          </div>
          ...
          <div className="mb-12">
            <div className="bg-bg-card p-6 rounded-xl border border-gray-600">
              <h2 className="text-2xl font-bold mb-4">👹 Understanding Twisted Characters</h2>
              <p className="text-text-secondary leading-relaxed mb-4">
                Twisted characters are the primary antagonists in Dandy's World, each with unique behaviors, 
                mechanics, and weaknesses. Understanding how they work is crucial for survival and progression.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h3 className="font-semibold mb-2">Behavior Patterns</h3>
                  <ul className="space-y-1 text-text-secondary">
                    <li>• Sound-based tracking</li>

...
export const regularCharacters: Character[] = [
  ...
  },
  {
    ...
    detailedGuide: {
      abilityMechanics: {
        active: {
          detailedDescription: "Bright Light creates a large light radius that reveals nearby Twisteds for 10 seconds. *Based on character description inference, actual effects subject to in-game performance*",
          howItWorks: "After activation, creates a large illuminated area that reveals all Twisted enemies within range.",
          bestUsage: "Use for area reconnaissance, before entering dark areas, or when suspecting enemies nearby.",
          visualEffects: "Bright light effects, large radius indicator, enemy highlighting."
        },
        passive: {
          detailedDescription: "Provides constant light radius and can see in dark areas. *Based on character description inference, actual effects subject to in-game performance*",
          howItWorks: "Automatically provides illumination around the character, visible in dark environments.",
          strategicValue: "Continuous visibility support, no activation required."
        }
      },
      strategies: {
        playingAs: {
          overview: "Illumination expert, provides visibility and reconnaissance support for the team.",
          tips: [
            "Use Bright Light in strategic locations",
            "Coordinate with team for area control",
            "Utilize passive ability for continuous visibility",
            "Stay in team center for maximum coverage"
          ],
          commonMistakes: [
            "Using light in unsuitable locations",
            "Ignoring team coordination",
            "Over-exposing position with light",
            "Not utilizing passive illumination"
          ],
          advancedTechniques: [
            "Coordinate with Vee for double reconnaissance",
            "Use light areas to control enemy movement",
            "Provide illumination at critical moments"
          ]
        },
        playingAgainst: {
          overview: "Brightney-regular is a visibility expert, need to avoid being exposed by light.",
          counterStrategies: [
            "Avoid entering light areas",
            "Use stealth to counter illumination",
            "Quickly pass through light zones"
          ],
          whatToAvoid: [
            "Staying in light areas",
            "Concentrating actions in illuminated zones",
            "Ignoring light area threats"
          ],
          teamComposition: [
            "Use high stealth characters",
            "High speed characters to pass quickly",
            "Disperse actions to reduce exposure"
          ]
        }
      },
      interactions: {
        synergies: {
          description: "Brightney-regular works best with intelligence and support characters.",
          bestPartners: [
            {
              character: "Vee",
              reason: "Vee provides intelligence, Brightney provides visibility",
              combo: "Intelligence + Visibility support"
            },
            {
              character: "Tisha",
              reason: "Tisha provides cleanup, Brightney provides visibility",
              combo: "Status management + Visibility"
            }
          ]
        },
        counters: {
          description: "Brightney-regular excels at visibility but is easily targeted.",
          strongAgainst: [
            {
              character: "Stealth characters",
              reason: "Uses light to reveal hidden enemies"
            }
          ],
          weakAgainst: [
            {
              character: "High damage characters",
              reason: "Low stealth, easily detected and eliminated"
            }
          ]
        }
      },
      scenarios: {
        ...
        bestSituations: ["Need visibility", "Team coordination"],
        challengingSituations: ["Open terrain", "High stealth enemies"],
        teamRoles: ["Visibility support", "Area reconnaissance", "Team coordination"]
      }
    }
  },
  {

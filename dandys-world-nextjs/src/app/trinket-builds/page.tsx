...
export const metadata: Metadata = {
  title: 'Trinket Optimizer',
  description: 'AI-powered trinket build optimizer for every character',
};

// Game style types
type GameStyle = 'extractor' | 'distractor' | 'support' | 'balanced';

const TrinketBuildsPage: React.FC = () => {
...
export default TrinketBuildsPage;

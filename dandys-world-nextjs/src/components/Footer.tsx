      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-text-secondary">
              ...
              <li>
                <ScrollToTopLink to="/progress-tracker" className="hover:text-accent-main transition-colors">
                  📈 Progress Tracker
                </ScrollToTopLink>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex space-x-4 text-text-secondary">
              ...
              <a href="#" className="hover:text-accent-main transition-colors" aria-label="GitHub">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 pt-8 border-t border-border-primary">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-text-secondary text-sm">© {currentYear} Dandy's World Characters. All rights reserved.</p>
            <div className="flex space-x-6 mt-4 md:mt-0 text-sm text-text-secondary">
              <ScrollToTopLink to="/privacy" className="hover:text-accent-main transition-colors">
                Privacy Policy
              </ScrollToTopLink>
              <ScrollToTopLink to="/terms" className="hover:text-accent-main transition-colors">
                Terms of Service
              </ScrollToTopLink>
            </div>
          </div>
